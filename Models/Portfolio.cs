...
namespace JaredResumeApp.Models
{
    public class Portfolio
    {
        ...
        public List<Skill> Skills { get; set; } = new List<Skill>()
                ...
                new Skill { Name = "C++", Description = "Part of Browsium's solution was desktop virtualization using C++. I also have project experience during my time at BYU-I working with C++." },
