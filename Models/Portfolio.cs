...
namespace JaredResumeApp.Models
{
    public class Portfolio
    {
        ...
        public List<Skill> Skills { get; set; } = new List<Skill>()
                ...
                new Skill { Name = "Windows Presentation Foundation (WPF)", Description = "I built an internal tool using WPF, and Open AI. This tool was used to generate 1,200 accurate, JSON-formatted definitions that cut over manual labor by over 50%."},
